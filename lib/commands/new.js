...
module.exports = function (cli) {
  ...
  var runExternalCommand = function runExternalCommand(command, args, options) {
    ...
    return cli.spawn(command, args, options).then(function () {
  ...
  var cleanUpSails = function cleanUpSails() {
    ...
    var sailsPackages = ['rm', 'grunt', 'ejs', 'grunt-contrib-clean', 'grunt-contrib-concat', 'grunt-contrib-copy', 'grunt-contrib-cssmin', 'grunt-contrib-jst', 'grunt-contrib-less', 'grunt-contrib-uglify', 'grunt-contrib-watch', 'grunt-sails-linker', 'grunt-sync', 'grunt-contrib-coffee', '--save'];
  ...
  var prepareSails = function prepareSails() {
    cli.debug('prepareSails');
    var sailsPackages = ['i', 'sails-generate-ember-blueprints', 'lodash', 'pluralize', 'sails-hook-autoreload@~0.11.4', 'balderdashy/sails-hook-dev', 'sails-disk', 'sails-hook-apianalytics', '--save'];
  ...
  var generateAppFiles = function generateAppFiles() {
